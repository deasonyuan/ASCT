function [net,stats] = cnn_train_dag_update_base(net, imdb, input, getBatch, varargin)
...
%lx    inputs ={'input1', gpuArray(ims1), 'input2', gpuArray(ims2),'label', gpuArray(labels)};
    inputs ={'input1', gpuArray(ims1),'label', gpuArray(labels)};
